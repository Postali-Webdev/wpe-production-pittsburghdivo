 ...
 */
	...
	function postali_child() {
        ...
        wp_register_style( 'google-fonts', 'https://fonts.googleapis.com/css?family=Open+Sans:400,800,700italic,700,600italic,600,400italic,300italic,300%7CAbril+Fatface%7CMontserrat:200,400%7COxygen:200,300,400,700,800&display=swap', array() );
		wp_enqueue_style('google-fonts');


        wp_register_style( 'icomoon', 'https://cdn.icomoon.io/152819/PittsburghFamily/style.css?h7nfgx', array() );
		...
		wp_register_script('tabs', get_stylesheet_directory_uri() . '/assets/js/tabs.min.js', array('jquery'));
